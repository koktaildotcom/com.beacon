...
class BeaconDevice extends Homey.Device {
    ...
    updateCapabilityValues(beacon) {
        ...
        if (false === this.hasCapability("homey_distance")) {
            this.addCapability("homey_distance")
        }
        let newDistance = this.getDistance(beacon.calibratedPower, beacon.rssi);
    ...
    getDistance(calibratedPower, rssi) {
