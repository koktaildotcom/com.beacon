...
class BeaconDevice extends Homey.Device {
    ...
    setDetect() {
        if (this.getCapabilityValue("detect") === false) {
            ...
            this.changeDetected++;
            Homey.app.log('beacon:' + device.getName() + " changed detect inside: " + this.changeDetected);
    ...
    setUndetect() {
        if (this.getCapabilityValue("detect") === true) {
            ...
            this.changeDetected++;
            Homey.app.log('beacon:' + device.getName() + " changed detect outside: " + this.changeDetected);
