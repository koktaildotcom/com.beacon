...
// The instances of this class represented a a specialized type of
...
class BeaconDetectingService {

    getBeaconFromAdvertisement(advertisement) {
        const beacon = {};
        beacon.name = (advertisement.localName ? advertisement.localName : advertisement.address);
        ...
        beacon.type = drivers.GENERIC;
        // take average power
        beacon.calibratedPower = -52.8;
        beacon.key = advertisement.uuid;
        return beacon;
    }
    ...
    /**
     * Get the metadata from the advertisement
     */
    getMetaData(beacon) {
        let nameStr;
        let frameDetailStr;
...
module.exports = BeaconDetectingService;
